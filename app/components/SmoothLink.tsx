...
export function SmoothLink({ href, className, children, ariaLabel, reveal = false, onNavigate }: { href: string; className?: string; children: ReactNode; ariaLabel?: string; reveal?: boolean; onNavigate?: () => void }) {
